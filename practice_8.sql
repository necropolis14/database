...
SELECT name FROM customers c LEFT OUTER JOIN orders o ON c.id = o.customer_id WHERE o.id IS NULL;

SELECT title, quantity, price_per_unit FROM products p INNER JOIN order_items oi ON oi.id = 1;
